const cvHeadings = [
  ...
  const templateLayout = {
    ...
    fragment: {
      ...
      header: {
        styles:
          "text-black relative m-2 px-3 flex flex-col w-3/4 justify-start items-start",
        elements: [
          {
            id: "name",
          },
      ...
      contact: {
        styles:
          "flex flex-col absolute text-base w-1/4 justify-between px-8 items-start top-0 right-10 m-2 p-3 gap-1",
        elements: [
          {
            id: "phone",
          },
